...
<form method="post" action="php/uabout.php">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name="dob" value="<?= $data['dob'] ?>" class="form-control" id="dob" placeholder="14 December,1997">
    </div>
    <div class="form-group col-md-6">
      <label for="website">Age</label>
      <input type="text" name="age" value="" class="form-control" id="Age" placeholder="enter your age">
    </div>
    <div class="form-group col-md-6">
      <label for="website">Website</label>
      <input type="text" name="website" value="<?= $data['website'] ?>" class="form-control" id="website" placeholder="www.example.com">
    </div>
    <div class="form-group col-md-6">
      <label for="website">Degree</label>
      <input type="text" name="Degree" value="" class="form-control" id="Degree" placeholder="Degree">
    </div>
    <div class="form-group col-md-6">
      <label for="website">Phone</label>
      <input type="text" name="Phone" value="" class="form-control" id="Phone" placeholder="+212687904633">
    </div>
    <div class="form-group col-md-6">
      <label for="website">Email</label>
      <input type="text" name="Email" value="" class="form-control" id="Email" placeholder="zbatty1297@gmail.com">
    </div>
    <div class="form-group col-md-6">
      <label for="website">City</label>
      <input type="text" name="City" value="" class="form-control" id="City" placeholder="Youssoufia, maroc">
    </div>
  </div>
